...
*/
	...
	app.environment = {
		...
		xssButton: document.querySelector("html body div.menu div.item[name=javascript]"),
		xssField: document.querySelector("html body div.menu div.item[name=javascript] input"),
		sessionConfig: {},
		relayConfig: {},
		autoFetch: async()=>{},
